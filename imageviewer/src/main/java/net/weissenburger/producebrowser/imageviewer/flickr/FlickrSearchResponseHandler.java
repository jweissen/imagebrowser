...
public class FlickrSearchResponseHandler implements IProduceResponseHandler {

    IProduceDeserializer<IProduceList> deserializer;

    public FlickrSearchResponseHandler(IProduceDeserializer<IProduceList> deserializer) {
    ...
    public void handleResponse(IProduceResponseCallback callback, JSONObject response) {
        ...
        try {
            list = deserializer.deserialize(response);
